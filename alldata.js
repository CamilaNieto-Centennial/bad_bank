    ...
    return (
        <div style={{margin: "2em"}}>
            <div className="row d-flex justify-content-center">
                <div className="col-md-10 col-lg-8 my-3" style={{border: "#3f3f3f  5px solid"}}>
                    <div className="row">
                        <div className="col-sm-5 bg-info rounded-left">
                        ...
                        <div className="col-sm-7 bg-white rounded-right">
                            <h2 className="mt-3 text-center">Your Basic Information</h2>
                            <hr className="mainHr"/>
                            <div className="row">
